...
import { Users, Eye, EyeOff, Clipboard } from 'lucide-react';
...
const StaffLogin = () => {
  ...
  const demoAccounts = [
    { email: 'staff@janjanmarine.com', password: 'password', name: 'Ana Rodriguez' },
    { email: 'maria.staff@janjanmarine.com', password: 'password', name: 'Maria Elena Santos' }
  ];
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Manage daily operations and assist customers
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8 bg-background">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="hidden lg:block text-center">
            ...
            <p className="text-muted-foreground">Access your work dashboard</p>
          </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="staff@janjanmarine.com"
                    value={email}
                ...
                {/* Demo Accounts */}
                <div className="space-y-2">
                  <Label className="text-sm text-muted-foreground">Demo Staff Accounts:</Label>
