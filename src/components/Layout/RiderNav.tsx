...
const riderNavigation = [
  ...
  { name: 'Assignment Management', href: '/assignments', icon: Package2 },
  { name: 'Live GPS Tracking', href: '/gps-tracking', icon: Navigation },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center h-16 px-6 border-b border-border">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-lg font-semibold text-card-foreground">Rider Portal</h1>
